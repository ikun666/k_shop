...
import (
	...
	"github.com/ikun666/k_shop/service/order/rpc/internal/logic"
...
func (s *OrderServer) Add(ctx context.Context, in *order.CreateRequest) (*order.CreateResponse, error) {
