...
func (c *orderClient) Add(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	out := new(CreateResponse)
...
func (UnimplementedOrderServer) Add(context.Context, *CreateRequest) (*CreateResponse, error) {
...
func _Order_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).Add(ctx, req.(*CreateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
