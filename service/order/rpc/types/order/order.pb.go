...
var file_rpc_order_proto_rawDesc = []byte{
	...
	0x61, 0x69, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xb6, 0x03, 0x0a, 0x05,
	...
	0x12, 0x32, 0x0a, 0x03, 0x41, 0x64, 0x64, 0x12, 0x14, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e,
...
var file_rpc_order_proto_depIdxs = []int32{
	...
	0,  // 8: order.Order.Add:input_type -> order.CreateRequest
	1,  // 9: order.Order.Create:output_type -> order.CreateResponse
	1,  // 10: order.Order.CreateRevert:output_type -> order.CreateResponse
	3,  // 11: order.Order.Update:output_type -> order.UpdateResponse
	5,  // 12: order.Order.Remove:output_type -> order.RemoveResponse
	7,  // 13: order.Order.Detail:output_type -> order.DetailResponse
	9,  // 14: order.Order.List:output_type -> order.ListResponse
	11, // 15: order.Order.Paid:output_type -> order.PaidResponse
	1,  // 16: order.Order.Add:output_type -> order.CreateResponse
